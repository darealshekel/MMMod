...
final class ServerBlockCatalog
{
    ...
    {
        return isValid(id(block));
    }

    static boolean isValid(String blockId)
    {
        return blockId != null && VALID_BLOCK_IDS.contains(blockId.trim().toLowerCase(Locale.ROOT));
    }

    static long validTotal(Map<String, Long> blocks)
    {
