...
public final class MmmColorEditorScreen extends CompatScreen
{
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta)
    {
        ...
        MmmUi.drawBorder(context, colorX, colorY, colorW, colorH, 0xFF343434);
        int markerX = colorX + Math.round(this.saturation * (colorW - 1));
        int markerY = colorY + Math.round((1.0F - this.brightness) * (colorH - 1));
        MmmUi.drawBorder(context, markerX - 2, markerY - 2, 5, 5, 0xFFFFFFFF);
        ...
        MmmUi.drawBorder(context, hueX, colorY, 24, colorH, 0xFF343434);
